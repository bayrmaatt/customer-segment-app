...
total_spending = st.number_input('Total Spending (Summary of Purchases)', min_value=0, max_value=5000, value=1000)
...
input_data = pd.DataFrame({'Age': [age], 'Income': [income], 'Total_Spending': [total_spending], 
